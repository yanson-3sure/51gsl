...
<div class="tab-change">
    <ul id="trains"></ul>
    <!-- 加载更多按钮 -->
    <div class="load-more-btn" data-url="/my/ajax/train" data-append-object="#trains">
...
<div class="tab-change hide">
    <ul id="strategies"></ul>
    <!-- 加载更多按钮 -->
    <div class="load-more-btn"  data-url="/my/ajax/strategy" data-append-object="#strategies">
        <a href="javascript:;" title="">加载更多<i class="icon"></i></a>
    </div>
</div>
...
<div class="tab-change hide">
    ...
    <!-- 加载更多按钮 -->
    <div class="load-more-btn"  data-url="/my/ajax/qa?type=1" data-append-object="#qa1" >
        <a href="javascript:;" title="">加载更多<i class="icon"></i></a>
    </div>

    <!-- 加载更多按钮 -->
    <div class="load-more-btn hide"  data-url="/my/ajax/qa?type=2" data-append-object="#qa2" >
        <a href="javascript:;" title="">加载更多<i class="icon"></i></a>
    </div>
</div>
@endsection
